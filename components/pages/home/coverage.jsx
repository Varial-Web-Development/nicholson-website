    ...
    <section className="p-4 pt-8 pb-12 md:px-[54px] md:pt-16 md:pb-24 lg:px-16 lg:pt-24 lg:pb-32 grid gap-8 md:gap-16">
      ...
      <div className="flex flex-col gap-8 md:gap-16 lg:flex-row flex-wrap justify-center items-center w-full">
        <div className="w-full md:w-fit grid gap-6 md:gap-7 justify-center justify-items-center p-6 md:p-8 border-[6px] border-nicholson-blue-500 rounded-[50px]">
          <Link href="/insurance-products/personal"><img src="/img/garage.svg" width="205" height="205" alt="Personal insurance page" className="md:w-[240px]" /></Link>
          <Link href="/insurance-products/personal"><h3 className="text-center font-semibold text-xl md:text-[32px]">Personal Insurance</h3></Link>
          ...
          <Link href="/insurance-products/personal">
            <a className="bg-nicholson-blue-500 text-white w-full text-center md:text-[19px] py-2.5 rounded-full shadow-sm">Explore Personal Insurance</a>
          </Link>
        </div>
        <div className="w-full md:w-fit grid gap-6 md:gap-7 justify-center justify-items-center p-6 md:p-8 border-[6px] border-nicholson-blue-500 rounded-[50px]">
          <Link href="/insurance-products/commercial"><img src="/img/business-insurance.svg" width="205" height="205" alt="Commercial insurance page" className="md:w-[240px]" /></Link>
          <Link href="/insurance-products/commercial"><h3 className="text-center font-semibold text-xl md:text-[32px]">Commercial Insurance</h3></Link>
          <p className="max-w-[35ch]">
          ...
          <Link href="/insurance-products/commercial">
            <a className="bg-nicholson-blue-500 text-white w-full text-center md:text-[19px] py-2.5 rounded-full shadow-sm">Explore Commercial Insurance</a>
          </Link>
        </div>
        <div className="w-full md:w-fit grid gap-6 md:gap-7 justify-center justify-items-center p-6 md:p-8 border-[6px] border-nicholson-blue-500 rounded-[50px]">
          <Link href="/insurance-products/life-and-health"><img src="/img/life-health-insurance.svg" width="196" height="205" alt="" className="md:w-[229px]" /></Link>
          <Link href="/insurance-products/life-and-health"><h3 className="text-center font-semibold text-xl md:text-[32px]">Life & Health Insurance</h3></Link>
          <p className="max-w-[35ch]">
          ...
          <Link href="/insurance-products/life-and-health">
            <a className="bg-nicholson-blue-500 text-white w-full text-center md:text-[19px] py-2.5 rounded-full shadow-sm">Explore Life & Health Insurance</a>
          </Link>
        </div>
      </div>
    </section>
