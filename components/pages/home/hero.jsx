  ...
  return (
    ...
    >
      <div className="relative z-10 grid gap-4 md:gap-8">
        <span className="text-[32px] md:text-5xl leading-[39px] md:leading-[59px] font-extrabold text-white w-[10ch] md:w-[15ch]">Where Coverage Meets <span className="text-nicholson-green-500">Community</span></span>
