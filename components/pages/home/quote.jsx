...
export default function QuoteSection() {
  return (
    <section className="section grid gap-8 md:gap-16 lg:gap-24 place-items-center bg-gradient-to-b from-nicholson-blue-500 via-[#2FA8E9] to-nicholson-green-500">
