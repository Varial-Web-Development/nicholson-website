...
export default function AthleticClubsPage() {
  return (
    <Layout>
      <Head>
        <title>Athletic Club, Fitness Studio, & Gym Coverage - Nicholson & Associates Insurance</title>
        <meta name="description" content="With our comprehensive commercial insurance policies, you can rest easy knowing your drive for a healthier community can keep going no matter what." />
      </Head>
      <main>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            <span className="text-nicholson-blue-500">Total</span> Coverage for Gyms and Fitness Studios
          </h1>
          <p>
          ...
          <ul>
            ...
            <li>Tenant Improvements and Betterments</li>
          </ul>
          <div className="bg-slate-100 grid gap-4 w-full max-w-[65ch] p-4 lg:p-8 shadow rounded-md">
            ...
            <Link href="#negligent-acts">→ Protection for Negligent Acts by Athletic Clubs</Link>
            <Link href="#property-coverage">→ Coverage for Athletic Club Property</Link>
          </div>
        </section>
        <section id="negligent-acts" className="section-alt flex flex-col gap-8 items-center">
          <h2>Protection for Negligent Acts by Athletic Clubs</h2>
          <p>
        ...
        <section id="property-coverage" className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Coverage for Athletic Club Property</h2>
          <p>
          ...
          <p>
            Not sure what coverage will be right for you? Our team of commercial insurance agents is ready to find the best insurance package for your gym, athletic club, or fitness studio. <Link href="/contact-us"><a className="text-nicholson-blue-500 underline">Contact us</a></Link> today to learn more.
          </p>
        </section>
      </main>
    </Layout>
