...
export default function BarsAndPubsPage() {
  return (
    <Layout>
      <Head>
        <title>Bar, Pub, & Tavern Coverage - Nicholson & Associates Insurance</title>
        <meta name="description" content="We have innovative insurance solutions to protect your interests and address these concerns so that you can skip the worry and focus on creating an amazing experience." />
      </Head>
      <main>
