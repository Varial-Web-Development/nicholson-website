...
export default function BreweriesAndDistilleriesPage() {
  return (
    <Layout>
      <Head>
        <title>Brewery & Distillery Coverage - Nicholson & Associates Insurance</title>
        <meta name="description" content="Our team of knowledgeable insurance professionals understands these needs and can seamlessly take the guesswork out of protecting your craft." />
      </Head>
      <main> 
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            Policies <span className="text-nicholson-blue-500">Crafted</span> for Breweries and Distilleries
          </h1>
          <p>
          ...
          <ul>
            ...
            <li>Products & Completed Operations</li>
            <li>Product Withdrawal</li>
            <li>Spoilage</li>
