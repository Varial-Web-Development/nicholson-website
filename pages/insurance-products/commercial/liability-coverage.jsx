      ...
      <main>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            <span className="text-nicholson-blue-500">Protect</span> Yourself Against Negligence
          </h1>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2>Commercial General Liability</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Commercial Umbrella</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Commercial Auto</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Contractors Liability</h2>
          <p>
          ...
          <p>
            Beyond the physical hazards, negligence can also occur due to errors or mistakes during the design or construction phase of a project. Contractors Liability protects you and your business in the event there is something wrong with the way a project is executed. The best laid plans may not always go right, and Contractors Liability covers the financial impacts caused by poor designs, incomplete implementation, or missing construction elements. It also protects you in the event of a contract dispute where the client is arguing the quality or details of the finished product. Even if there are no obvious signs of negligence, disputes can still happen due to miscommunications or misunderstandings about client expectations, so Contractors Liability can be essential in protecting your interests.
          </p>
          <p>
            Remember, negligence is accidental and unexpected action where another prudent person would have acted similarly. Even with Contractors Liability coverage, it is always important to still hire qualified subcontractors and industry professionals to support every project and make every effort to fully execute the job to the highest standards. This will help mitigate questions of subpar workmanship executed by your hired staff. 
          </p>
        </section>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Cyber Liability</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Directors & Officers Liability </h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Employment Practices Liability</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Environmental Liability</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Errors & Omissions</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Fiduciary Liability</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Garagekeepers Legal Liability</h2>
          <p>
            As a nation bound to the road, local auto shops and mechanics provide a truly essential service. Drivers rely on their skill and expertise to keep them safe on the road and maintain or fix their car so it goes mile after mile without a hitch. Some repair work or maintenance may take a few days, which requires the owner to leave the vehicle in the care of the auto shop. If the car is damaged while in your professional care, you certainly don't want to be left to cover the additional costs to fix it. Garagekeepers Liability offers protection for losses that occur during the course of service so that you can take care of your client no matter what happens.
          </p>
          <p>
            Garagekeepers Liability covers damage or loss to property that is in the care, custody, and control of an auto shop. In other words, auto shops have a unique exposure since they keep their clients' cars on their property for repair or maintenance. There are a number of factors that could result in damage or loss of the vehicle, including inclement weather, accidental damage from repair equipment, or theft. No matter the cause, it is your responsibility to take the utmost care of the customer's vehicle while it is in your hands, and if something happens to it, you want to be able to cover it without question. Garagekeepers Liability gives you the ability to easily repair or replace a car damaged while in your control and ensures your business is protected against potential claims or lawsuits. 
          </p>
        </section>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Liquor Liability</h2>
          <p>
