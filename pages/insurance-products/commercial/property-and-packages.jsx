...
export default function PropertyAndPackagesInsurancePage() {
  return (
    <Layout>
      <Head>
        <title>Property and Packages Coverage - Nicholson & Associates Insurance</title>
        <meta name="description" content="We provide comprehensive commercial packages that incorporate a range of coverages so you can seamlessly get all the protection you need through one easy policy." />
      </Head>
      <main>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            Insurance Packages & Property Coverage for <span className="text-nicholson-blue-500">Every</span> Industry 
          </h1>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Business Auto Insurance</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Business Owners Policy</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Commercial Package Policy</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Commercial Property Insurance</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Crop Hail Coverage</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Farm and Ranch Insurance</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Inland Marine Insurance</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Landlord Package</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Ocean Marine Insurance</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Public Entity Programs</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Trucking Insurance</h2>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          <h2 className="max-w-[20ch] leading-tight text-center">Workers Compensation</h2>
          <p>
