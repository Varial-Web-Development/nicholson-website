...
export default function RestaurantsInsurancePage() {
  return (
    <Layout>
      <Head>
        <title>Restaurant Coverage - Nicholson & Associates Insurance</title>
        <meta name="description" content="With our restaurant insurance policies, comprehensive and industry-specific coverage can be tailored to your needs so you can keep serving it up your way, every day." />
      </Head>
      <main> 
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            Risk Management <span className="text-nicholson-blue-500">Solutions</span> for Restaurant Owners
          </h1>
          <p>
        ...
        <section className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            Want to learn more? Our team of commercial insurance agents is ready to answer your questions and find the best restaurant insurance package for your business.
          </p>
        </section>
      </main>
    </Layout>
