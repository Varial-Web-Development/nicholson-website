      ...
      <main>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            <span className="text-nicholson-blue-500">Guarantee</span> Your Work With a Surety Bond
          </h1>
          <p>
        ...
        <section id="contractors" className="section-alt flex flex-col gap-8 items-center">
          ...
          <ul className="list-disc list-inside max-w-[65ch] flex flex-col gap-4">
            <li>Bid Bond: obligate a contractor to follow the terms of a bid</li>
            <li>Payment Bond: obligate a contractor to pay all subcontractors and material suppliers</li>
            <li>Performance Bond: obligate a contractor to meet specific performance standards</li>
            <li>Warranty Bond: obligate a contractor to honor the terms of a warranty</li>
            <li>License Bond: obligating a contractor to follow state licensure requirements</li>
          </ul>
          <p>
        ...
        <section id="fidelity" className="section-alt flex flex-col gap-8 items-center">
          ...
          <ul className="list-disc list-inside max-w-[65ch] flex flex-col gap-4">
            <li>Background checks prior to hiring</li>
            <li>Requiring 2 signatures for all checks</li>
            <li>Reconciling bank accounts by someone without fiduciary responsibility</li>
            <li>Conducting audits of financial records and inventory</li>
