      ...
      <main>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            Coverage for <span className="text-nicholson-blue-500">Catastrophes</span>
          </h1>
          <p>
        ...
        <section id="earthquake" className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            Today, earthquakes are specifically excluded on many standard Homeowners Insurance policies because of the widespread damage and high expenses. There are still some insurance carriers for homes that allow for the coverage to be added as an endorsement, as well as companies that offer standalone Earthquake policies. Either way, this coverage is typically only a few hundred dollars a year, which is well worth the extensive protection offered and subsequent peace of mind. 
          </p>
          <p>
        ...
        <section id="flood" className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            Flood Insurance isn't something you should only carry if you have a mortgage, though. Floods can cause catastrophic damage and are strictly excluded on most Homeowners policies. It is important to make sure you have separate coverage to repair or rebuild your home in the event it is damaged in a flood. Flood policies are very similar to Homeowners Insurance in that they provide coverage for your dwelling, any separate structures on the property, and your personal belongings. Since it is focused solely on recovering from a physical loss caused by a flood, it does not include any liability coverage.
          </p>
          <p>
        ...
        <section id="personal-umbrella" className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            A Personal Umbrella Insurance policy is a liability-only policy that provides additional Liability coverage above and beyond what you currently carry. They often begin at a limit of $1,000,000 to provide that essential cushion in the event of a catastrophic accident. It may sound like an unnecessary amount of coverage, but the reality is that high-cost claims happen more than you may think. Consider a serious car accident where multiple people are urgently rushed to the hospital in critical condition and need life-saving procedures; or where a pedestrian is struck in a crosswalk that becomes permanently paralyzed is unable to work; or worse, the breadwinner of a family is struck while cycling at night and killed. 
          </p>
          <p>
        ...
        <section id="key-coverages" className="section-alt flex flex-col gap-8 items-center">
          ...
          <div>
            ...
            <p>
              Even the most responsible of people may find themselves negligent for damages or injuries to others, which is where Liability coverage comes in handy. This coverage protects your assets by covering the costs others incur due to your actions. In the event of catastrophic losses, Liability protection can be the difference between a comfortable lifestyle and your very livelihood.
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Dwelling</h3>
            <p>
              On a catastrophic insurance policy like Flood or Earthquake, this coverage pays for the repair or reconstruction of your home after a specific natural disaster. Just like on a Home policy, limits are determined by conducting a Reconstruction Cost Estimate, which uses data such as square footage, bathrooms, and interior and exterior materials.          
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Separate Structures</h3>
            <p>
              Most properties have a separate building such as a detached garage, shop, or boathouse. This coverage is designed to repair or rebuild a separate structure in the event of the covered catastrophe. This limit is often 10% of the dwelling amount, though it can and should be adjusted for any separate structures with a higher value. 
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Personal Property</h3>
            <p>
              With years of homeownership, it is normal to accumulate many items that would be costly to replace all at once after a catastrophic loss. This coverage pays to replace your covered belongings damaged or destroyed in a natural disaster. Personal Property coverage ensures that everything in your home can be replaced so you don't have to start from square one. This is often 75% of the dwelling limit, but can be set higher if needed.
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Combined Single Limit</h3>
            <p>
              On some catastrophic policies, a Combined Single Limit may be available. Instead of having each coverage separate, everything is combined under one single limit, hence the name. This means the Dwelling, Separate Structures, Personal Property, and even Additional Living Expenses are all covered under one large lump sum rather than limited by an individual amount.
            </p>
          </div>
        </section>
      </main>
