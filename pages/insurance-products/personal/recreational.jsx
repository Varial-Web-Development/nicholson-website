...
export default function RecreationalInsurancePage() {
  return (
    <Layout>
      <Head>
        <title>Toys & Recreational Vehicle Coverage - Nicholson & Associates Insurance</title>
        <meta name="description" content="With adequate insurance coverage, you can let the good times roll no matter what happens." />
      </Head>
      <main>
        <section className="section-alt flex flex-col gap-8 items-center">
          <h1 className="text-center text-5xl max-w-[20ch] mx-auto lg:w-fit leading-tight">
            Where <span className="text-nicholson-blue-500">Fun</span> Meets Protection
          </h1>
          <p>
        ...
        <section id="boat" className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            Boat Insurance is a broad category for a variety of vessels. From sailboats and speedboats to yachts and catamarans, there is a policy out there to cover your watercraft's unique specifications. Every boat also comes with its own set of risks and considerations depending on how and where it is used and stored. With Pacific Northwest weather, many boat owners and enthusiasts may be inclined to lay-up their hull until the summer season comes back around. Many policies offer a savings for storage months when the watercraft isn't being actively used.
          </p>
          <p>
        ...
        <section id="motorcycle" className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            In 2021, Motorcycle Insurance became mandatory in the state of Washington. Many people may feel this was an unnecessary requirement because of the perceived damage potential of a motorcycle. However, the reality is that while a motorcycle isn't as destructive as a car, it can still cause damage or injury to others. Rather than taking this risk, opt for Motorcycle Insurance and avoid state fines while properly protecting yourself and those around you in the event of an accident.
          </p>
          <p>
            Beyond liability, Motorcycle Insurance also provides coverage for damages to the bike itself. Depending on the motorcycle, you may have put a lot of time, money, and energy into getting it running just how you like it, and an accident shouldn't undo all of that hard work. With this protection, you can easily repair or replace your motorcycle in the event of a wreck, or even theft or vandalism. No matter where you go, you will have the right coverage to keep riding easy.
          </p>
          <p>
        ...
        <section id="rv" className="section-alt flex flex-col gap-8 items-center">
          ...
          <p>
            From motor homes to travel trailers, recreational vehicles bring ease with travel, and your insurance should provide the same seamless experience. Recreational Vehicle Insurance provides coverage for your investment in the event it is damaged or destroyed while out on the road. While auto insurance can extend coverage to a travel trailer, this is exclusively for when it is attached to your vehicle. Once you reach the campsite, this coverage is no longer applicable, leaving you with a huge gap. A separate Recreational Vehicle Insurance policy is highly recommended to make sure your trailer is fully covered not only against damage, but also for liability reasons. If someone is hurt because of negligence on the campsite, this would fall under Liability coverage on the RV policy to properly protect your interests.
          </p>
          <p>
        ...
        <section id="key-coverages" className="section-alt flex flex-col gap-8 items-center">
          ...
          <div>
            ...
            <p>
              These two coverages often go hand in hand since they both protect physical damages to your vehicle. So what's the difference? Comprehensive covers damages caused by things other than a collision, such as a tree branch falling on your motorcycle or ATV. Collision coverage, on the other hand, strictly covers damages to your car caused by you colliding with another object, be that another car, the garage door, or a telephone pole. Both come with a deductible of your choice that you pay out of pocket in the event you file a claim to cover the cost of repairs.
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Towing</h3>
            <p>
              If you happen to get stranded on the side of the road while out on a motorcycle ride or cruising in your RV, you want to have a way to get home. This coverage will pay for the expense to tow your recreational vehicle either to the nearest repair shop or to your home. It usually comes with a mileage limit, so be sure to verify how far your coverage will take you.
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Custom Equipment</h3>
            <p>
              Motorcycles, boats, ATVs, and all the other fun toys often have special options that you can customize either with the manufacturer or on your own. This coverage protects custom equipment installed on a recreational vehicle so that you are reimbursed for loss to additional on your motorcycle, boat, and more.
            </p>
          </div>
          <div>
            <h3 className="text-lg lg:text-3xl">Liability</h3>
            <p>
              Even while out enjoying the day, accidents can happen. This coverage ensures you have coverage for negligent acts in case you accidentally cause damage or injury to others. Liability protection is essential for ATVs, boats, motorcycles, and RVs since operation comes with risk of minor to major accidents.
            </p>
          </div>
        </section>
      </main>
